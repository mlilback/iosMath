...
- (instancetype _Nonnull ) initWithInner:(MTMathListDisplay*_Nonnull) inner leftDelimiter:(MTDisplay*_Nonnull) leftDelimiter rightDelimiter:(MTDisplay*_Nonnull) rightDelimiter atIndex:(NSUInteger) index NS_DESIGNATED_INITIALIZER;
